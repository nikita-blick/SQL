...
CREATE OR ALTER PROCEDURE sp_InserHolidaysFor	
		@year		AS	SMALLINT,
...
BEGIN
	...
	CASE @holiday		--SWITCH
		WHEN N'Нов%'			THEN	dbo.GetNewYearHolidaysStartDate(@year)	--CASE '1'    все это для того,чтобы не высавлять расписание в выходные и праздничные дни 
