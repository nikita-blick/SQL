...
(
	...
	CONSTRAINT FK_DDR_Discipline	FOREIGN KEY (discipline) REFERENCES Disciplines(discipline_id), --CONSTRAINT - ограничение(имя)(какой тип)(какое поле)(куда оно сылается)
