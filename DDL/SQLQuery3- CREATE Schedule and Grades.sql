...
CREATE TABLE Grades
(
	student		INT			CONSTRAINT FK_Grades_Stidents	FOREIGN KEY REFERENCES Students(student_id),
...
CREATE TABLE Exams
(
	student		INT			CONSTRAINT FK_Exams_Stidents	FOREIGN KEY REFERENCES Students(student_id),
...
(
	student		INT			CONSTRAINT FK_Results_Stidents	FOREIGN KEY REFERENCES Students(student_id),
	...
	CONSTRAINT  CK_RESULT_OR_ÑOMMENT	CHECK ([result] IS NOT NULL OR comment IS NOT NULL),
